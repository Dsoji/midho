...
class AppColors {
  ...
  static MaterialColor primaryColor = const MaterialColor(
    0xFFF55825,
    <int, Color>{
      50: Color(0xFFFEEEE9), // #feeee9
      100: Color(0xFFFCCBBB), // #fccbbb
      200: Color(0xFFFAB29B), // #fab29b
      300: Color(0xFFF88F6D), // #f88f6d
      400: Color(0xFFF77951), // #f77951
      500: Color(0xFFF55825), // #f55825
      600: Color(0xFFDF5022), // #df5022
      700: Color(0xFFAE3E1A), // #ae3e1a
      800: Color(0xFF873014), // #873014
      900: Color(0xFF672510), // #672510
    },
  );
  ...
  static MaterialColor secondaryColor = const MaterialColor(
    0xFF030A50,
    <int, Color>{
      50: Color(0xFFE6E7EE), // #e6e7ee
      100: Color(0xFFB1B3C9), // #b1b3c9
      200: Color(0xFF8B8EAF), // #8b8eaf
      300: Color(0xFF565B8A), // #565b8a
      400: Color(0xFF353B73), // #353b73
      500: Color(0xFF030A50), // #030a50
      600: Color(0xFF030949), // #030949
      700: Color(0xFF020739), // #020739
      800: Color(0xFF02062C), // #02062c
      900: Color(0xFF010422), // #010422
    },
  );
  static MaterialColor whiteColor = const MaterialColor(
    ...
    <int, Color>{
      ...
      200: Color(0xFFFDFDFD), // #fdfdfd
      300: Color(0xFFFCFCFC), // #fcfcfc
      400: Color(0xFFFBFBFB), // #fbfbfb
      500: Color(0xFFFAFAFA), // #fafafa
      600: Color(0xFFE4E4E4), // #e4e4e4
      700: Color(0xFFB2B2B2), // #b2b2b2
      800: Color(0xFF8A8A8A), // #8a8a8a
      900: Color(0xFF696969), // #696969
    },
  );
