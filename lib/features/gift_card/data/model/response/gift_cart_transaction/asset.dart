...
class Asset {
  ...
  @override
  String toString() {
    return 'Asset(id: $id, type: $type, name: $name, baseCurrency: $baseCurrency, exchangeCurrency: $exchangeCurrency, moq: $moq, rate: $rate, active: $active, category: $category, ecodeRate: $ecodeRate, createdAt: $createdAt, updatedAt: $updatedAt, id: $id)';
  }
